            ...
            <span className='lg:flex'>
              ...
              <span className='box__kuller ml-2 '>
                ...
                <p className=' mb-2 font-normal text-gray-700 dark:text-gray-400'>
                  Аренда только для юридических лиц Каждое 3 месяц должно купить
            ...
            <span className='lg:flex'>
              <span className='box__kuller '>
                ...
                <p className='mb-3 font-normal text-gray-700 dark:text-gray-400'>
                  ...
                  до10 C Доставка по городу бесплатно.
                </p>
                <mark className='btn text-xl p-1  rounded-md text-red-600 mt-1'>
                  Подарок 5 капсул воды
                </mark>
              ...
              <span className='box__kuller   ml-2  '>
                ...
                <p className=' mb-2 font-normal text-gray-700 dark:text-gray-400'>
                  ...
                  200 капсул воды Доставка бесплатно
                </p>
                <mark className=' text-xl p-1  rounded-md text-red-600  '>
                  Куллер бесплатно
                </mark>
            ...
            <span className='lg:flex'>
              <span className=' box__kuller  '>
                ...
                <p className='mb-3 font-normal text-gray-700 dark:text-gray-400'>
                  ...
                  пластик Количество кранов для подачи воды - 3шт Охлаждение -
                  компрессорное Температура нагревания 40 С до 90 C Температура
                  охлаждения 6 С до10 C Доставка по городу бесплатно.
                </p>
                <mark className='btn text-xl p-1  rounded-md text-red-600 mt-1'>
                  Подарок 5 капсул воды
                </mark>
              ...
              <span className='box__kuller  ml-2  '>
                ...
                <p className=' mb-2 font-normal text-gray-700 dark:text-gray-400'>
                  Аренда только для юридических лиц Каждое 3 месяц должно купит
                  150 капсул воды Доставка бесплатно
                </p>
                <mark className=' text-xl p-1  rounded-md text-red-600  '>
                  Куллер бесплатно
                </mark>
