    ...
    <>
      ...
      >
        ...
        <p className='text-center w-1/2 mr-auto  ml-auto text-xl '>
          Сегодня компания «Du`a» является одним из самых крупных производителей
          безалкогольных напитков в Узбекистане. Годами построенные отношения с
          партнерами, заслуженная репутация компании, налаженное производство,
          логистика и дистрибуция приносят обильные плоды.
        </p>
      </section>
    </>
  );
